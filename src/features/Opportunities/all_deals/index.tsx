...
function AllDeals() {
  const [selected, setSelected] = useState("active-deals");
  ...
  return (
    <main className='mx-8 mt-6 relative mb-20'>
      ...
      <div className='flex gap-10 items-start'>
        ...
        {showForm && (
          <CreateBox
            btntext='Launch deal'
            handleclick={() => {}}
            title='Create deal for Red tees'
          >
      ...
      <DeleteModal
        ...
        handleDelete={() => {}}
        open={modal}
        text='Do you really want to delete this deal? This process cannot be undone.'
      />
    </main>
  );
}
